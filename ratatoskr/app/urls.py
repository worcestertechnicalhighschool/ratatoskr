...
urlpatterns = [
    ...
    path('schedule/<schedule:schedule>/subscribe', views.subscribe_schedule, name='subscribe'),
    path('schedule/<schedule:schedule>/unsubscribe', views.unsubscribe_schedule, name='unsubscribe'),
